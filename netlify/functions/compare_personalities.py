...
def handler(event, context):
    ...
    try:
        ...
        personalities = body.get('personalities', ['neutral', 'calm_mentor', 'witty_friend', 'therapist_style'])
        ...
        if use_memory and cleaned_messages:
            chat_history = "\n\n".join([
                ...
                for msg in cleaned_messages[:-1]  # Exclude the new message
            ])
...
Provide: preferences, emotional patterns, important facts. Be concise."""
        ...
        for personality_key in personalities:
            ...
            personality_config = PERSONALITIES[personality_key]
            ...
            response = client.chat.completions.create(
                ...
                temperature=0.8 if personality_key != "neutral" else 0.7
            )
            
            comparisons[personality_key] = {
        ...
        return {
            'statusCode': 200,
            'headers': headers,
            'body': json.dumps({'comparisons': comparisons})
        }
